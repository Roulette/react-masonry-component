...
var Masonry = isBrowser ? require('masonry-layout') : null
...
var MasonryComponent = React.createClass({
    ...
    initializeMasonry: function(force) {
        if (!this.masonry || force) {
            ...
            this.props.onLayoutComplete( this.domChildren);
    ...
    componentDidMount: function() {
        ...
        this.masonry.on('revealComplete', function (subclasses){
            self.props.onLayoutComplete(subclasses.map(function (cl) {
                return cl.element;
            }))
        });
    },
